...
<img alt="parametric design" src="../docs/parametric.png" width="500px">
...
<img alt="hershey font" src="../docs/hersheyfont.png" width="500px">

compared to Century Gothic:

<img alt="century gothic font" src="../docs/centurygothic.png" width="500px">
...
<img alt="files at http://localhost:8000/" src="../docs/localhost.png" width="500px">
...
<img alt="lead ins and outs" src="../docs/leadinsouts.png" width="500px">
...
<img alt="selecting continuous path" src="../docs/pathselection.png" width="500px">

They have been selected in order so that they are engraved in a continuous toolpath:

<img alt="continuous toolpath" src="../docs/pathselectiontoolpath.png" width="500px">
...
<img alt="character traversal" src="../docs/etraversal.png" width="500px">

These tick marks are also traversed in a consistent direction:

<img alt="tick traversal" src="../docs/ticktraversal.png" width="500px">
